...
const PracticeReports: React.FC = () => {
  ...
  const { data: reportData, isLoading, refetch } = useGeneratePracticeReportQuery(filters, {
    skip: false,
  });
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Practice-Wise Reports</h1>
        <p className="text-gray-600">
          Generate comprehensive reports with business rules applied automatically
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg shadow-lg p-6 text-white">
            <h2 className="text-2xl font-bold mb-2">
              {filters.practice} Practice Report
            </h2>
