...
export default function Analytics() {
  const { data: trends, isLoading: trendsLoading } = useGetAssignmentTrendsQuery();
  const { data: practices, isLoading: practicesLoading } = useGetPracticeDistributionQuery();
  const { data: approvals, isLoading: approvalsLoading } = useGetApprovalMetricsQuery();
  const { data: grades, isLoading: gradesLoading } = useGetGradeDistributionQuery();
  const { data: regions, isLoading: regionsLoading } = useGetRegionStatsQuery();
