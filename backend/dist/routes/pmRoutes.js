...
// Skill Management
router.get('/employees/skills/distribution', pmController_1.getEmployeeSkillDistribution);
router.get('/employees/skills/coverage', pmController_1.getSkillManagementCoverage);
router.get('/employees/skills/preview', pmController_1.getFilteredEmployeesForSkillUpdate);
router.put('/employees/skills/bulk-update', pmController_1.bulkUpdateEmployeeSkills);
router.post('/employees/skills/remove', pmController_1.removeEmployeeSkill);
router.patch('/employees/:employeeId/skill', pmController_1.updateSingleEmployeeSkill);
// Manual PM Override
