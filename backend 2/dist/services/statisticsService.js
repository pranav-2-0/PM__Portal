...
class StatisticsService {
    ...
    async getPMCapacityHeatmap() {
      ...
      SELECT 
        ...
        pm.reportee_count,
        pm.max_capacity,
        ROUND((pm.reportee_count::decimal / pm.max_capacity) * 100, 0) as utilization_percent,
        CASE 
          WHEN pm.reportee_count::decimal / pm.max_capacity < 0.5 THEN 'Low'
          WHEN pm.reportee_count::decimal / pm.max_capacity < 0.75 THEN 'Medium'
          WHEN pm.reportee_count::decimal / pm.max_capacity < 0.9 THEN 'High'
          ELSE 'Critical'
